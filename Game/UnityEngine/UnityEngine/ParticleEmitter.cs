...
namespace UnityEngine
{
	public class ParticleEmitter : Component
	{
		...
		public extern Vector3 worldVelocity
		{
			[MethodImpl(MethodImplOptions.InternalCall)]
			get;
			[MethodImpl(MethodImplOptions.InternalCall)]
		...
		public extern Vector3 localVelocity
		{
			[MethodImpl(MethodImplOptions.InternalCall)]
			get;
			[MethodImpl(MethodImplOptions.InternalCall)]
		...
		public extern Vector3 rndVelocity
		{
			[MethodImpl(MethodImplOptions.InternalCall)]
			get;
			[MethodImpl(MethodImplOptions.InternalCall)]
		...
		{
			Emit3(pos, velocity, size, energy, color);
		}
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		private extern void Emit3(Vector3 pos, Vector3 dir, float size, float energy, Color color);
