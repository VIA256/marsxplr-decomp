...
namespace UnityEngine
{
	...
	public class DetailPrototype
	{
		...
		//FUCKprivate Color m_HealthyColor = m_HealthyColor;
		private Color m_HealthyColor;

		//FUCKprivate Color m_DryColor = m_DryColor;
		...
		private float m_LightmapFactor = 1f;

		private int m_GrayscaleLighting;
		...
		public float lightmapFactor
		{
			get
			{
				return m_LightmapFactor;
			}
			set
			{
				m_LightmapFactor = value;
			}
		}

		public bool grayscaleLighting
		{
			get
			{
				return m_GrayscaleLighting != 0;
			}
			set
			{
				m_GrayscaleLighting = (value ? 1 : 0);
			}
		}
