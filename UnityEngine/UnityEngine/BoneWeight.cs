namespace UnityEngine
{
	public struct BoneWeight
	{
		...
		public override bool Equals(object other)
		{
			...
			int result;
			if (boneIndex0.Equals(boneWeight.boneIndex0) && boneIndex1.Equals(boneWeight.boneIndex1) && boneIndex2.Equals(boneWeight.boneIndex2) && boneIndex3.Equals(boneWeight.boneIndex3))
			{
				Vector4 vector = new Vector4(weight0, weight1, weight2, weight3);
				Vector4 vector2 = new Vector4(boneWeight.weight0, boneWeight.weight1, boneWeight.weight2, boneWeight.weight3);
				result = (vector.Equals(vector2) ? 1 : 0);
			}
			else
			{
				result = 0;
		...
		public static bool operator ==(BoneWeight lhs, BoneWeight rhs)
		{
			...
			{
				Vector4 vector = new Vector4(lhs.weight0, lhs.weight1, lhs.weight2, lhs.weight3);
				Vector4 vector2 = new Vector4(rhs.weight0, rhs.weight1, rhs.weight2, rhs.weight3);
				result = ((vector == vector2) ? 1 : 0);
			}
			else
			{
				result = 0;
